---
title: "Komparasi PM 52/2018, PM 26/2021 & PM 6/2026"
aliases:
  - "PKPS 47 Comparison"
  - "Deregistrasi Pesawat Udara Indonesia"
tags:
  - kemenhub
  - pkps-47
  - idera
...
```mermaid
graph TD
    KM49["KM 49/2009<br>+ KM 82/2004"] -->|dicabut oleh Ps. 4| PM52["PM 52/2018<br>(Peraturan Induk)"]
    PM52 -->|diubah sebagian oleh Ps. I| PM26["PM 26/2021<br>(Peraturan Perubahan)"]
    PM52 -->|dicabut oleh Ps. 18 huruf a| PM6["PM 6/2026<br>(Peraturan Pengganti Total)"]
...
```mermaid
graph TD
    A["Permohonan Penghapusan<br>Tanda Pendaftaran<br>(Ps. 13 / 47.31)"] --> B{Siapa pemohon &<br>alasan apa?}

    B -->|"Pemilik/operator/<br>kuasa (6 alasan administratif):<br>habis sewa guna usaha,<br>sepakat diakhiri,<br>pindah negara,<br>rusak total akibat kecelakaan,<br>tak dipakai lagi,<br>sengaja dirusak/dihancurkan"| C["Jalur Administratif Biasa<br>(47.31 huruf b angka 1<br>a-f)"]
    C --> C1["Diajukan ke Dirjen<br>→ dievaluasi<br>→ terbit sertifikat penghapusan"]

    B -->|"Wanprestasi (cedera janji)<br>penyewa DAN pemohon<br>MEMEGANG IDERA yang sah"| D["Jalur Self-Help<br>TANPA Putusan Pengadilan<br>(47.31 huruf b.1.g & huruf c)"]
    D --> D1["authorized party/<br>certified designee ajukan<br>surat permohonan + IDERA asli"]
    D1 --> D2["Dirjen WAJIB proses<br>maks. 5 hari kerja<br>sejak berkas lengkap & benar"]

    B -->|"Wanprestasi (cedera janji)<br>TAPI TIDAK ADA IDERA"| E["Jalur Yudisial/Arbitrase<br>WAJIB (47.31 huruf e)"]
    E --> E1["Penetapan tindakan<br>sementara pengadilan"]
    E --> E2["Putusan arbitrase ATAU<br>putusan pengadilan"]
...
```mermaid
graph TD
    A["Sertifikat Pendaftaran<br>diterbitkan SEBELUM<br>PM 6/2026 berlaku"] --> B["Tetap berlaku sampai<br>masa berlaku sertifikat<br>berakhir"]
    B --> C["Penyesuaian ke format/<br>ketentuan PM 6/2026<br>dilakukan SAAT<br>PERPANJANGAN sertifikat"]
```
