...
> [!deepdive] Deep Dive — Reaksi vs Respons dalam Konteks Hukum
> | | **Reaksi** | **Respons** |
> |---|---|---|
> | **Mekanisme** | Otomatis, impulsif | Disengaja, reflektif |
> | **Waktu** | Milidetik (amigdala) | Detik (korteks prefrontal) |
...
> **Catatan kritis:** Tindakan terapeutik hanya efektif jika sistemnya mendukung — Indonesia memiliki keterbatasan serius: rasio psikiater:narapidana sangat rendah.
...
> 4. **Thrilling/novelty seeking** — sensasi
> 5. **Compliance to internal command** — mematuhi halusinasi (psikotik)
> 6. **Survival** — respons terhadap ancaman
