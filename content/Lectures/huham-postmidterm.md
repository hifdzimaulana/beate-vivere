---
title: "Hukum & HAM - Post-Midterm"
tags: [HUHAM, HAM, hukum, lectures]
---

> [!ABSTRACT]
> Dokumen ini menyajikan catatan akademik lengkap mengenai tiga pilar utama Hukum dan Hak Asasi Manusia (HUHAM): </br>**(1) Hak Turut Serta dalam Pemerintahan (HTSDP)**, yang menganalisis hak partisipasi warga negara dari perspektif konstitusional, legal, dan demokratis; </br>**(2) Hak Anak**, yang membahas definisi anak dalam sistem hukum Indonesia, prinsip-prinsip perlindungan berdasarkan Konvensi Hak Anak (CRC), serta mekanisme peradilan pidana anak termasuk diversi dan keadilan restoratif; dan </br>**(3) Hukum Humaniter Internasional**, yang mencakup sejarah, sumber hukum, asas-asas (military necessity, humanity, distinction, proportionality), serta mekanisme penegakan dari tingkat nasional hingga Mahkamah Pidana Internasional (ICC). </br>Catatan ini disusun berdasarkan Undang-Undang Dasar 1945, UU No. 39/1999 tentang HAM, UU No. 23/2002 tentang Perlindungan Anak, UU No. 11/2012 tentang Sistem Peradilan Pidana Anak (SPPA), Konvensi Jenewa 1949, Protokol Tambahan 1977, ICCPR, ICESCR, CRC, dan instrumen hukum internasional lainnya, dengan penambahan konteks perbandingan, kritik implementasi, dan studi kasus ilustratif.
...
```mermaid
graph TD
    A["Hak Asasi Manusia<br/>(Natural Rights)"] -->|"Dikonstitusikan"| B["Hak Konstitusional<br/>(UUD 1945)"]
    B -->|"Dijabarkan dalam UU"| C["Hak Legal<br/>(Undang-Undang & Peraturan)"]
    B -->|"Contoh: Pasal 28D ayat (3)"| D["Hak Turut Serta<br/>dalam Pemerintahan"]
    C -->|"Contoh: UU 39/1999"| E["Perlindungan HAM<br/>di Indonesia"]
    style A fill:#c0392b,stroke:#333,stroke-width:2px,color:#fff
    style B fill:#2980b9,stroke:#333,stroke-width:2px,color:#fff
...
```mermaid
graph TD
    A["UUD 1945<br/>(Norma Dasar)"] --> B["Undang-Undang<br/>(UU HAM, UU Perlindungan Anak, dll.)"]
    B --> C["Peraturan Pemerintah<br/>(PP)"]
    C --> D["Peraturan Presiden<br/>(Perpres)"]
    D --> E["Peraturan Daerah<br/>(Perda)"]
    style A fill:#e74c3c,stroke:#333,stroke-width:3px,color:#fff
    style B fill:#e67e22,stroke:#333,stroke-width:2px,color:#fff
    style C fill:#d4a017,stroke:#333,stroke-width:2px,color:#fff
...
```mermaid
graph LR
    A["Prinsip Perlindungan Anak"] --> B["Non-Diskriminasi"]
    A --> C["Kepentingan Terbaik<br/>Bagi Anak"]
    A --> D["Hidup & Perkembangan"]
    A --> E["Penghargaan terhadap<br/>Pendapat Anak"]
    B --> F["Perlindungan Universal"]
    C --> G["Pertimbangan Utama"]
    D --> H["Hak Fundamental"]
    E --> I["Partisipasi Anak"]
    style A fill:#e74c3c,stroke:#333,stroke-width:2px,color:#fff
    style C fill:#d4a017,stroke:#333,stroke-width:3px,color:#fff
```
...
```mermaid
graph TD
    A["Anak Diduga Melakukan<br/>Tindak Pidana"] --> B{"Usia Anak?"}
    B -->|"< 12 tahun"| C["Diserahkan ke Orang Tua/Wali<br/>atau Program Pembinaan<br/>(Pasal 21 SPPA)"]
    B -->|"12-18 tahun"| D{"Memenuhi Syarat Diversi?"}
    D -->|"Ya: Ancaman < 7 tahun,<br/>bukan pengulangan"| E["Musyawarah Diversi<br/>(Keadilan Restoratif)"]
    D -->|"Tidak"| F["Proses Peradilan Pidana<br/>(Pengadilan Anak)"]
    E --> G["Hasil Kesepakatan:<br/>- Pengembalian kerugian<br/>- Rehabilitasi<br/>- Pendidikan/Pelatihan<br/>- Pelayanan masyarakat"]
    G --> H{"Kesepakatan Berhasil?"}
    H -->|"Ya"| I["Perkara Ditutup"]
    H -->|"Tidak"| F
    style A fill:#e74c3c,stroke:#333,stroke-width:2px,color:#fff
...
```mermaid
graph LR
    A["Asas Hukum Humaniter"] --> B["Military Necessity"]
    A --> C["Humanity"]
    A --> D["Chivalry"]
    A --> E["Distinction"]
    A --> F["Proportionality"]
    B --> G["Kekuatan yang diperlukan<br/>untuk menaklukkan musuh"]
    C --> H["Larangan penderitaan<br/>yang tidak perlu"]
    D --> I["Kejujuran & larangan<br/>tipu muslihat"]
    E --> J["Pembedaan kombatan<br/>vs sipil"]
    F --> K["Larangan serangan berlebihan<br/>terhadap korban sipil"]
    style A fill:#e74c3c,stroke:#333,stroke-width:2px,color:#fff
    style C fill:#2ecc71,stroke:#333,stroke-width:3px,color:#fff
...
```mermaid
graph TD
    A["Populasi dalam Konflik Bersenjata"] --> B["Kombatan<br/>(Combatants)"]
    A --> C["Penduduk Sipil<br/>(Civilians)"]
    B --> D["Boleh menjadi sasaran<br/>serangan militer"]
    C --> E["Tidak boleh menjadi<br/>sasangan serangan"]
    C --> F["Dilindungi oleh<br/>Hukum Humaniter"]
    B --> G["Berhak menjadi<br/>Tawanan Perang"]
