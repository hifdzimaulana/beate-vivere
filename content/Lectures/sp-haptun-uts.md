...
```mermaid
graph TD
    A[Pendaftaran Gugatan] --> B[Pemeriksaan Administrasi Kepaniteraan]
    B --> C{Dismissal Procedure</br>Ps. 62 UU 5/1986}
    C -->|Tidak Lolos| D[Penetapan Dismissal]
    D --> E{Perlawanan 14 hari?}
    E -->|Dibenarkan| F[Gugur Demi Hukum</br>Lanjut Acara Biasa]
    E -->|Ditolak| G[Perkara Selesai]
    C -->|Lolos| H[Pemeriksaan Persiapan</br>Ps. 63 UU 5/1986]
    F --> H
    H --> I[Sidang Terbuka:</br>Gugatan - Jawaban]
    I --> J[Replik - Duplik]
    J --> K[Pembuktian</br>Ps. 100 UU 5/1986]
    K --> L[Kesimpulan Ps. 97 ayat 1]
    L --> M[Putusan Ps. 108]
```
...
```mermaid
graph LR
    A[Tindakan Pemerintahan] --> B[Tindakan Sepihak</br>Hukum Publik]
    A --> C[Tindakan Dua Pihak</br>Perjanjian]
    B --> D[Keputusan/KTUN]
    B --> E[Tindakan Faktual]
    C --> F[Perjanjian Hukum Publik</br>Wewenang Pemerintahan]
    C --> G[Perjanjian Hukum Privat</br>Perdata Biasa]
```
...
```mermaid
graph LR
    A[19 Okt 2015</br>SK 455 diterbitkan] --> B[5 Okt 2015</br>BAP Pengawasan dibuat]
    B --> C{PT Kasuari mengetahui</br>KTUN kapan?}
    C -->|Terbukti tahu sejak awal| D[90 hari dihitung sejak</br>tanggal mengetahui - lama lewat]
    C -->|Baru tahu mendekati Mei 2017| E[Gugatan 12 Mei 2017</br>berpotensi masih dalam tenggang]
    D --> F[Gugatan berpotensi</br>N.O. - lewat waktu]
    E --> G[Gugatan berpotensi</br>diterima secara formil]
```
...
```mermaid
graph TD
    A[JAWABAN TERGUGAT] --> B[I. DALAM EKSEPSI]
    A --> C[II. DALAM POKOK PERKARA]
    A --> D[III. PETITUM]
    B --> B1[Eksepsi Gugatan</br>Telah Lewat Waktu]
    B --> B2[Eksepsi Obscuur Libel]
    C --> C1[Kewenangan &</br>Prosedur Penerbitan SK]
    C --> C2[Strict Liability</br>Ps. 88 UU 32/2009]
    C --> C3[Kesesuaian dengan</br>Ps. 80 UU 32/2009]
    D --> D1[Tolak Eksepsi]
    D --> D2[Tolak Gugatan Seluruhnya]
```
